 ...
 * environment variable to forget. The previous arrangement read
 * `config/SpecialStudies.csv` at runtime through a `../../../` path that
 * resolved to `/config/...` inside the bundle — a catalog the function could
 * never have found.
 *
